...
| <br>&nbsp;&nbsp;🐍 **[Snake Game - IO](./SnakeGame-IO)**&nbsp;&nbsp;<br><br> | <br>&nbsp;&nbsp;The classic arcade game, fully playable in the terminal with basic rendering.&nbsp;&nbsp;<br><br> |
...
- `src/` : Implementation files executing the core logic (`.cpp`).
